...
class QuestionViewController: UIViewController {
    ...
    var questions: [Question] = [
        Question(text: "Which food do you like the most?",
                 type: .single,
                 answers: [
                    Answer(text: "Steak", type: .fox),
                    Answer(text: "Fish", type: .polarbear),
                    Answer(text: "Carrots", type: .monkey),
                    Answer(text: "Corn", type: .frog)]),
        Question(text: "Which activities do you enjoy?",
                 type: .multiple,
                 answers: [
                    Answer(text: "Swimming", type: .frog),
                    Answer(text: "Sleeping", type: .polarbear),
        ...
        Question(text: "How much do you enjoy car rides?",
                 ...
                 answers: [
                    ...
                    Answer(text: "I get a little nervous", type: .polarbear),
                    Answer(text: "I barely notice them", type: .monkey),
                    Answer(text: "I love them", type: .fox)])]
    var questionIndex = 0;
